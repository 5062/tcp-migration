...
def create_network() -> Mininet:
    ...
    |                 s1                |
    |                                   |
    +--s1-eth3-----s1-eth1-----s1-eth2--+
          |           |            |
          |           |            |
       h3-eth0     h1-eth0      h2-eth0
    ...
    h1 = net.addHost('h1')  # server1
    h2 = net.addHost('h2')  # server2
    ...
    link_h2s1.intf1.config(mac='00:00:00:00:00:01', ip='10.0.0.2/24')
...
if __name__ == '__main__':
    ...
    net.terms += make_xterm(c0, title='Snort',
                            cmd='snort -i c0-eth0 -A console -A unsock -l /tmp -c ./snort_rules.rules')
    ...
    net.terms += make_xterm(h3, xterm_args=['-geometry', '160x30+1050+920'])
